...
#define RECOVERY_GRAPHICS_USE_LINELENGTH
#ifdef RECOVERY_BGRA
...
static void print_fb_var_screeninfo()
{
	...
	fprintf(stderr, "vi.xres_virtual: %d\n", vi.xres_virtual);
	fprintf(stderr, "vi.yres_virtual: %d\n", vi.yres_virtual);
	fprintf(stderr, "vi.xoffset: %d\n", vi.xoffset);
	fprintf(stderr, "vi.yoffset: %d\n", vi.yoffset);
...
fprintf(stderr, "fi.smem_len: %x\n", fi.smem_len);
    ...
    fprintf(stderr, "setting JANKY BACKBUFFER\n");
