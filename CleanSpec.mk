...
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/A66/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/A66/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/A66/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/A66/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/A66/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/A66/recovery/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/A66/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/A66/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/A66/recovery/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/A66/system/build.prop)
...
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/A66/recovery/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/A66/system/build.prop)
$(call add-clean-step, rm -rf $(OUT_DIR)/target/product/A66/obj/EXECUTABLES/mm-vdec-omx-test*_intermediates)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/A66/symbols/system/bin/mm-vdec-omx-test*)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/A66/system/bin/mm-vdec-omx-test*)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/A66/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/A66/recovery/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/A66/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/A66/root/default.prop)
